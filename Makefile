# RazionOS root Makefile, derived from the ToaruOS 2.x build system
TOOLCHAIN=util
BASE=base
...
KRK_MODS += $(patsubst lib/kuroko/%,$(BASE)/lib/kuroko/%,$(wildcard lib/kuroko/*.krk lib/kuroko/*/*.krk lib/kuroko/*/*/*.krk))
