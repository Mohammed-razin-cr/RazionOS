...
/* Basic text strings */
#define BASE_VERSION "RazionOS Bootloader 0.1 Alpha"
...
char * COPYRIGHT_TEXT = "RazionOS is based on ToaruOS (NCSA license).";
char * LINK_TEXT = "Upstream: https://github.com/klange/toaruos";
