...
int main(int argc, char * argv[]) {
	if (argc < 2) {
		execvp("about-dialog",(char *const[]){
			...
			"--",
			"RazionOS 0.1 Alpha.",
			"Experimental x86_64 desktop operating system.",
			"Native desktop, local-first AI architecture, and reproducible live ISO.",
			"-",
			"Based on ToaruOS by K. Lange and contributors.",
			"© 2011-2026 K. Lange, et al.",
			"Upstream components: NCSA/UIUC license.",
			"RazionOS project changes: identity, desktop integration, AI services, and tooling.",
			"-",
