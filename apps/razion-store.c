...
static const store_app_t catalogue[] = {
	...
	{"Razion Assistant", "razion-assistant", "Native AI panel for chat, local-first file search, Pulse handoff, and provider status.", "0.1.0", "System image", "Utilities", "razion-pulse", "/bin/razion-assistant", "NCSA", "Razion AI SDK, Razion graphics", "AI requests; user query text", "Added provider-independent assistant panel.", 1},
	{"System Center", "razion-system-center", "Storage, updates, notifications, screenshots, lock screen, and About in one dashboard.", "0.1.0", "System image", "System", "razion-settings", "/bin/razion-system-center", "NCSA", "Razion graphics, toastd, screenshot tool", "system status: read; local settings: write", "Added modern desktop management surface.", 1},
	...
	{"Screenshot Tool", "yutani-screenshot", "Capture the full display, active window, or a selected region.", "0.1.0", "System image", "Graphics", "image-x-generic", "/bin/yutani-screenshot", "NCSA", "Yutani compositor", "screen capture", "Exposed through System Center and Launcher.", 0},
	{"Lock Screen", "razion-lock", "Full-screen RazionOS session lock overlay for demos and short breaks.", "0.1.0", "System image", "System", "razion-settings", "/bin/razion-lock", "NCSA", "Yutani overlay", "session overlay", "Added alpha presentation lock; not password security.", 0},
