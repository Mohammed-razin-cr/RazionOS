# Welcome to RazionOS 0.1 Alpha

RazionOS provides a familiar Unix-like environment, but please be
...
Razion Desktop uses ToaruOS's Yutani compositing window server and includes
many common keybindings:
